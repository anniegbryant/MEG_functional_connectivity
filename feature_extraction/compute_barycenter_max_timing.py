...
# Filter to specific regions during onset
            ...
            # Z-score
            CS_onset = zscore(CS_onset)
            PFC_onset = zscore(PFC_onset)
            VIS_onset = zscore(VIS_onset)
            CS_offset = zscore(CS_offset)
            PFC_offset = zscore(PFC_offset)
            VIS_offset = zscore(VIS_offset)

            CS_onset_abs = zscore(CS_onset_abs)
            PFC_onset_abs = zscore(PFC_onset_abs)
            VIS_onset_abs = zscore(VIS_onset_abs)
            CS_offset_abs = zscore(CS_offset_abs)
            PFC_offset_abs = zscore(PFC_offset_abs)
            VIS_offset_abs = zscore(VIS_offset_abs)
