...
n_jobs=10
cmd="qsub -o /project/hctsa/annie/github/MEG_functional_connectivity/cluster_output/Cogitate_MEG_group_averaged_classification.out \
...
# n_jobs=10
# cmd="qsub -o /project/hctsa/annie/github/MEG_functional_connectivity/cluster_output/Cogitate_MEG_individual_epoch_classification_^array_index^.out \
