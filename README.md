...
❗ All **intermediate data files** needed to replicate analysis and visuals in this project, including the preprocessed MEG time series from relevant brain regions, can be downloaded from an accompanying [Zenodo repository](https://zenodo.org/records/15315238) that we compiled.
...
```
To replicate our analyses and visuals, after cloning this repository to your local machine, please download the zipped `data.zip` archive from [Zenodo](https://zenodo.org/records/15315238) to your local clone of the repo and extract to the `data/` folder.
